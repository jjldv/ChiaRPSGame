...
async function getOpenGames(showLoading = false) {
    const RGames = await Utils.fetch("/getOpenGames",{},showLoading);
    if (RGames.success) {
        ...
        RGames.historyGames.forEach(game => {
            ...
            const player2Display = game.namePlayer2 === "----" ? "----" : (game.namePlayer2 === game.publicKeyPlayer2 ? "Anonymous" : game.namePlayer2);
